...
func initDefaultNetworks(db *gorm.DB) error {
	networkUpsertQueries := []string{
		...
		"INSERT INTO networks (id, created_at, name, description, chain_id, is_production, cloneable, enabled, config) VALUES ('c00b580c-6a0a-435a-8cb5-4da65ee5720e', now(), 'Ganache testnet', 'Ethereum local ganache testnet', '101010', false, false, false, '{\"client\":\"geth\",\"engine_id\":\"ethash\",\"is_ethereum_network\":true,\"native_currency\":\"ETH\",\"network_id\":101010,\"platform\":\"evm\",\"protocol_id\":\"pow\",\"websocket_url\":\"ws://localost:8545\",\"json_rpc_url\":\"http://localhost:8545\",\"security\":{\"egress\":\"*\",\"ingress\":{\"0.0.0.0/0\":{\"tcp\":[8545,30303],\"udp\":[30303]}}}}');",
		"INSERT INTO networks (id, created_at, name, description, chain_id, is_production, cloneable, enabled, config) VALUES ('78944edc-e71e-4dd0-b503-7991086542f5', now(), 'Hedera Mainnet', 'Hedera Hashgraph public-permissioned mainnet', '0.0.102', true, false, false, '{\"type\": \"hedera\", \"security\": {\"egress\": \"*\", \"ingress\": {\"0.0.0.0/0\": {\"tcp\": [50111, 50211], \"udp\": []}}}}')",
		"INSERT INTO networks (id, created_at, name, description, chain_id, is_production, cloneable, enabled, config) VALUES ('9f3b2e72-554d-40e1-b995-1daf43c2eadd', now(), 'Hedera Testnet', 'Hedera Hashgraph public-permissioned testnet', '0.0.102-testnet', true, false, false, {\"type\": \"hedera\", \"security\": {\"egress\": \"*\", \"ingress\": {\"0.0.0.0/0\": {\"tcp\": [50111, 50211], \"udp\": []}}}}')",
	}
