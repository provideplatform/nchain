...
// SplunkProvider is a connector.ProviderAPI implementing orchestration for Provide
...
// InitSplunkProvider initializes and returns the Provide connector API provider
func InitSplunkProvider(connectorID uuid.UUID, networkID, applicationID, organizationID *uuid.UUID, model *gorm.DB, config map[string]interface{}) *SplunkProvider {
...
func (p *SplunkProvider) apiClientFactory(basePath *string) *ipfs.Shell {
	uri := ""
	if basePath != nil {
		uri = *basePath
	}
...
func (p *SplunkProvider) apiURLFactory(path string) *string {
	if p.apiURL == nil {
		return nil
	}
...
func (p *SplunkProvider) rawConfig() *json.RawMessage {
...
func (p *SplunkProvider) Deprovision() error {
...
func (p *SplunkProvider) Provision() error {
...
func (p *SplunkProvider) DeprovisionNode() error {
	node := &network.Node{}
...
func (p *SplunkProvider) ProvisionNode() error {
	node := &network.Node{
		NetworkID:      *p.networkID,
		ApplicationID:  p.applicationID,
		OrganizationID: p.organizationID,
...
func (p *SplunkProvider) Reachable() bool {
	loadBalancers := make([]*network.LoadBalancer, 0)
	p.model.Association("LoadBalancers").Find(&loadBalancers)
...
// Create impl for SplunkProvider
func (p *SplunkProvider) Create(params map[string]interface{}) (*ConnectedEntity, error) {
	return nil, errors.New("create not implemented for Provide connectors")
}

// Find impl for SplunkProvider
func (p *SplunkProvider) Find(id string) (*ConnectedEntity, error) {
	return nil, errors.New("read not implemented for Provide connectors")
}

// Update impl for SplunkProvider
func (p *SplunkProvider) Update(id string, params map[string]interface{}) error {
	return errors.New("update not implemented for Provide connectors")
}

// Delete impl for SplunkProvider
func (p *SplunkProvider) Delete(id string) error {
	return errors.New("delete not implemented for Provide connectors")
}

// List impl for SplunkProvider
func (p *SplunkProvider) List(params map[string]interface{}) ([]*ConnectedEntity, error) {
	return nil, errors.New("list not implemented for Provide connectors")
}

// Query impl for SplunkProvider
func (p *SplunkProvider) Query(q string) (interface{}, error) {
