...
func ethClonableDisabledConfigNetwork2221122202220() (n *fixtures.FixtureMatcher) {
	...
	name := "ETH NonProduction Cloneable Disabled Config empty cloneable_cfg empty chainspec_url "
