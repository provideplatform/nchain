...
func ethClonableDisabledConfigNetwork2220222202220() (n *fixtures.FixtureMatcher) {
	...
	name := "ETH NonProduction Cloneable Disabled Config w cloneable_cfg nil chainspec "
