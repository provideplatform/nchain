...
func ethClonableDisabledConfigNetwork2220122202220() (n *fixtures.FixtureMatcher) {
	...
	name := "ETH NonProduction Cloneable Disabled Config empty cloneable_cfg nil chainspec "
