...
func ethClonableDisabledConfigNetwork2221222202220() (n *fixtures.FixtureMatcher) {
	...
	name := "ETH NonProduction Cloneable Disabled Config w cloneable_cfg empty chainspec_url "
