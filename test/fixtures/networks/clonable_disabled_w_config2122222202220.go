...
func ethClonableDisabledConfigNetwork2122222202220() (n *fixtures.FixtureMatcher) {
	...
	name := "ETH NonProduction Cloneable Disabled Config w cloneable_cfg w chainspec_url w block_explorer_url nil chain "
