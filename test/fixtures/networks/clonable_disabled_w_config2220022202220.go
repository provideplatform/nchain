...
func ethClonableDisabledConfigNetwork2220022202220() (n *fixtures.FixtureMatcher) {
	...
	name := "ETH NonProduction Cloneable Disabled Config nil cloneable_cfg nil chainspec "
