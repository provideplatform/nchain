...
func ethClonableDisabledConfigNetwork0222222202220() (n *fixtures.FixtureMatcher) {
	...
	name := "ETH NonProduction Cloneable Disabled Config w cloneable_cfg w chainspec_url nil block_explorer_url"
