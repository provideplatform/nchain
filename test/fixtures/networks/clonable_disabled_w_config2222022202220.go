...
func ethClonableDisabledConfigNetwork2222022202220() (n *fixtures.FixtureMatcher) {
	...
	name := "ETH NonProduction Cloneable Disabled Config nil cloneable_cfg w chainspec_url "
