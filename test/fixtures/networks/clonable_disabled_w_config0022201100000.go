...
func ethClonableDisabledConfigNetwork0022201100000() (n *fixtures.FixtureMatcher) {
	...
	name := "ETH NonProduction Cloneable Disabled Config w cloneable_cfg w chainspec_url nil block_explorer_url nil chain nil engine_id eth:f lb:f nil currency nil network_id nil protocol_id "
